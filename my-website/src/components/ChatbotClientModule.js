...
// This script will run on every page and inject the chatbot component
if (typeof window !== 'undefined') {
  ...
  function initializeChatbot() {
    ...
    buttonContainer.style.cssText = 'position: fixed; right: 80px; top: 10px; z-index: 1000; display: inline-block;';
    buttonContainer.id = 'chatbot-button-container';
